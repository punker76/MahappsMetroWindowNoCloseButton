...
namespace WpfFramework
{
    ...
    public partial class MainWindow : INotifyPropertyChanged
    {
        ...
        {
            get => new RelayCommand(p => EnterLicenseAction());
        }

        private async void EnterLicenseAction()
        {
            
            var customDialog = new CustomDialog
            {
                Title = Strings.AddLicense
            };


            await this.ShowMetroDialogAsync(customDialog);
        }
        public ICommand AgreeEulaCommand
        {
            get => new RelayCommand(p => EnterLicenseAction());
        }

        private async void AgreeEulaAction()
        {
