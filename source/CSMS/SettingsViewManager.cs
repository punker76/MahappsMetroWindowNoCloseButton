...
namespace WpfFramework
{
    public static class SettingsViewManager
    {
        ...
        public static List<SettingsViewInfo> List => new List<SettingsViewInfo>
        {
            ...
            // Applications
            new SettingsViewInfo(SettingsViewName.Repetier, new PackIconMaterial { Kind = PackIconMaterialKind.Speedometer }, Group.Applications),
            new SettingsViewInfo(SettingsViewName.OctoPrint, new PackIconSimpleIcons{ Kind = PackIconSimpleIconsKind.OctopusDeploy }, Group.Applications),
            ...
            // License
            new SettingsViewInfo(SettingsViewName.License,new PackIconMaterial{ Kind = PackIconMaterialKind.AccountKey }, Group.License),
        ...
        public static string TranslateName(SettingsViewName name)
        {
            switch (name)
            {
                ...
                case SettingsViewName.Repetier:
                    return Resources.Localization.Strings.SettingsNameRepetierServer;
                case SettingsViewName.OctoPrint:
                    return Resources.Localization.Strings.SettingsNameOctoPrint;
                ...
                case SettingsViewName.License:
                    return Resources.Localization.Strings.SettingsNameLicense;
